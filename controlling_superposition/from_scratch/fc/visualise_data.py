...
for file in os.listdir("from_scratch/fc/accuracies"):
    slope=float(file[0]+"."+file[1:])
    with open(f"from_scratch/fc/accuracies/{file}","rb") as accuracy_file:
...
plt.savefig("from_scratch/fc/accuracies.png",bbox_inches="tight")
